...
function PerformanceChart({ points }: { points: GraphicPoint[] }) {
  ...
  const yLabels = geom.isEmpty ? STATIC_Y_LABELS : geom.yLabels;
      ...
      <div className={s.chartSvgOverlay}>
        ...
        >
          ...
          {geom.isEmpty ? (
            ...
            /* Динамический чарт из данных API с точками сделок */
            <>
