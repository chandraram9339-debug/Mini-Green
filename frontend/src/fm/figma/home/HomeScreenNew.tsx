...
/* ── Chart scale labels (matching Builder.io) ─────────────── */
const CHART_SCALE_LABELS = [
  "7.00%",
  "6.00%",
  "5.00%",
  "4.00%",
...
/* ── Performance Chart (Builder.io SVG, responsive) ─────────── */
function PerformanceChart() {
  return (
    <div className={s.chartWrapper}>
      {/* Y-axis grid with labels */}
      <div className={s.chartGrid}>
        {CHART_SCALE_LABELS.map((label) => (
      ...
      {/* SVG line chart overlaid on grid */}
