...
function IconPlus() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M4 8L12 8" stroke="white" strokeLinecap="square" strokeLinejoin="round" />
      <path d="M8 12L8 4" stroke="white" strokeLinecap="square" strokeLinejoin="round" />
    </svg>
  );
}
function IconMinus() {
...
function IconReferral() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path d="M8 10.667A2.667 2.667 0 1 0 8 5.333a2.667 2.667 0 0 0 0 5.334Z" stroke="white" strokeWidth="1.067" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M10.667 6A2.667 2.667 0 0 1 12.333 8c0 1.473-.747 2.667-1.666 2.667-.92 0-1.667-1.194-1.667-2.667" stroke="white" strokeWidth="1.067" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function TabCard({ meta, totalAmount, count, isActive, onSelect }: TabCardProps) {
  return (
    <button
      className={`${s.tabCard} ${isActive ? s.tabCardActive : s.tabCardInactive}`}
      onClick={onSelect}
  ...
  return (
    <div className={s.screen}>
      ...
      <div className={s.body}>
        ...
        <section className={s.balanceSection} aria-label={t("deposit.balanceAria")}>
          ...
          <div className={s.actionRow}>
            <Link to={routes.depositTopUp} className={s.btnTopUp}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M12 6V18" stroke="white" strokeWidth="1.6" strokeLinecap="square" strokeLinejoin="round" />
                <path d="M6 12H18" stroke="white" strokeWidth="1.6" strokeLinecap="square" strokeLinejoin="round" />
              </svg>
        ...
        {/* History: tabs + list */}
        <div className={s.historySection} aria-label={t("deposit.historyAria")}>
          {/* Summary tab cards */}
