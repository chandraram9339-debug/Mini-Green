...
export const messagesEn = {
  ...
  "home.botActionsAria": "Bot actions: start, stop, channel, and chat",
  ...
  "topup.chooseMethodTitle": "How would you like to add funds?",
  "topup.chooseMethodSubtitle": "Choose a method. You can go back and switch any time.",
  "topup.methodTrc20Title": "USDT (TRC20 · Tron)",
  "topup.methodTrc20Subtitle": "Scan QR or copy address — classic deposit",
  "topup.methodTonTitle": "TON Wallet",
  "topup.methodTonSubtitle": "TON Connect — pay with TON or USDT jetton",
  "topup.changeMethod": "Change method",
  "topup.trc20StepTitle": "Deposit on Tron",
  "topup.tonStepTitle": "Pay with TON",
  "topup.tonStepIntro":
    "Connect your wallet and confirm the transfer. Your Telegram ID is attached as the memo automatically.",
...
export const messagesEs: Partial<Record<MessageKey, string>> = {
  ...
  "home.botActionsAria": "Acciones del bot: iniciar, detener, canal y chat",
  ...
  "topup.chooseMethodTitle": "¿Cómo quieres añadir fondos?",
  "topup.chooseMethodSubtitle": "Elige un método. Puedes volver y cambiar cuando quieras.",
  "topup.methodTrc20Title": "USDT (TRC20 · Tron)",
  "topup.methodTrc20Subtitle": "Red Tron — QR y dirección — depósito clásico",
  "topup.methodTonTitle": "TON Wallet",
  "topup.methodTonSubtitle": "TON Connect — paga con TON o jetton USDT",
  "topup.changeMethod": "Cambiar método",
  "topup.trc20StepTitle": "Depositar en Tron",
  "topup.tonStepTitle": "Pago con TON",
  "topup.tonStepIntro":
    "Conecta tu monedero y confirma la transferencia. Tu ID de Telegram se añade al memo automáticamente.",
