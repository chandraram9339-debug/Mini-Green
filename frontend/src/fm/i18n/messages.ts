...
export const messagesEn = {
  ...
  "demo.chooseMethodTitle": "Fund your demo account",
  "demo.chooseMethodSubtitle": "Practice with virtual USDT, or try TON Connect on the real network.",
  "demo.methodVirtualTitle": "Virtual USDT",
  "demo.methodVirtualSubtitle": "Pick an amount — nothing is charged",
  "demo.methodTonTitle": "TON Wallet",
  "demo.methodTonSubtitle": "TON Connect — same rules as live crediting",
  "demo.changeMethod": "Change method",
  "demo.virtualStepTitle": "Virtual USDT",
  "demo.tonStepTitle": "TON Wallet",
  "demo.tonStepIntro":
    "Connect your wallet to send TON or USDT (jetton). On-chain rules match live crediting — these transfers are real, not simulated.",
...
export const messagesEs: Partial<Record<MessageKey, string>> = {
  ...
  "demo.chooseMethodTitle": "Fondos para la cuenta demo",
  "demo.chooseMethodSubtitle": "Practica con USDT virtual o prueba TON Connect en la red real.",
  "demo.methodVirtualTitle": "USDT virtual",
  "demo.methodVirtualSubtitle": "Elige un importe — no se cobra nada",
  "demo.methodTonTitle": "TON Wallet",
  "demo.methodTonSubtitle": "TON Connect — mismas reglas de abono que en vivo",
  "demo.changeMethod": "Cambiar método",
  "demo.virtualStepTitle": "USDT virtual",
  "demo.tonStepTitle": "TON Wallet",
  "demo.tonStepIntro":
    "Conecta tu cartera para enviar TON o USDT (jetton). Las reglas en cadena son las mismas que en vivo: estas transferencias son reales, no simuladas.",
