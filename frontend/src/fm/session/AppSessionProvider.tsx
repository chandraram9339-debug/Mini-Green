...
import { fetchUiSettings, mergeUiSettingsFromWallet } from "../api/fetchUiSettings";
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      if (!initData) {
        ...
        if (allowDevWithoutTelegram() && bearer) {
          ...
          try {
            ...
            const ui = mergeUiSettingsFromWallet(settings, w);
            setState((s) => ({ ...s, phase: "ready", mode: "live", wallet: w, uiSettings: ui ?? undefined, notificationUnreadCount: 0 }));
          } catch (e) {
      ...
      try {
        ...
        const ui = mergeUiSettingsFromWallet(settings, merged);
        setState((s) => ({ ...s, phase: "ready", mode: "live", wallet: merged, uiSettings: ui ?? undefined, notificationUnreadCount: 0 }));
      } catch (e) {
