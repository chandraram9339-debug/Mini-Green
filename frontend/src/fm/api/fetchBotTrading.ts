...
const STATIC_FALLBACK: BotTradingSnapshot = {
  ...
  byPeriod: {
    ...
    "3d": { totalDeals: 78, successful: 39, unsuccessful: 39, profitPercent: -0.72 },
    "7d": { totalDeals: 78, successful: 39, unsuccessful: 39, profitPercent: -0.72 },
    "1m": { totalDeals: 78, successful: 39, unsuccessful: 39, profitPercent: -0.72 },
  },
};
