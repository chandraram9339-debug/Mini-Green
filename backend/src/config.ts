...
export const config: AppConfig = {
  ...
  minWithdrawMinor: numEnv("MIN_WITHDRAW_MINOR", 500),
  withdrawFeeBps: numEnv("WITHDRAW_FEE_BPS", 1000),
  withdrawFeeFixedUsdtHuman: numEnv("WITHDRAW_FEE_FIXED_USDT", 0),
  depositFeeFixedUsdtHuman: numEnv("DEPOSIT_FEE_FIXED_USDT", 0),
  depositFeeBps: numEnv("DEPOSIT_FEE_BPS", 0),
  minDepositUsdtHuman: numEnv("MIN_DEPOSIT_USDT", 10),
