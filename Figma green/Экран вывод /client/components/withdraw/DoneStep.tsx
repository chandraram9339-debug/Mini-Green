...
export default function DoneStep({ recipient, amount, commission }: DoneStepProps) {
  return (
    <div className="flex flex-col flex-1 px-5 gap-5 overflow-y-auto">
      ...
      <div className="flex flex-col items-center gap-3 mb-4">
        <div className="w-[52px] h-[52px] rounded-full bg-app-green flex items-center justify-center">
          <svg width="28" height="28" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M17.334 24.917L23.834 31.417L36.834 18.417" stroke="#191919" strokeWidth="3.46667" strokeLinecap="square" strokeLinejoin="round"/>
          </svg>
        </div>
        <span className="font-outfit text-[20px] font-medium text-app-green">Done!</span>
      </div>
    </div>
  );
}
