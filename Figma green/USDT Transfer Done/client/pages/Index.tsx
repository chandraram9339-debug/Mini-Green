    ...
    <div className={styles.root}>
      <div className={styles.container}>
        ...
        <div className={styles.appBar}>
          ...
          <h1 className={styles.appBarTitle}>USDT Transfer</h1>
        ...
        <div className={styles.receiptSection}>
          ...
          <div className={styles.listItem}>
            <span className={styles.itemLabel}>Recipient</span>
            <div className={styles.itemValue}>
              <span className={styles.valueGreen}>UQC4...754C</span>
            </div>
          </div>
          ...
          <div className={styles.listItem}>
            ...
            <div className={styles.itemValue}>
              <span className={styles.valueLargeGreen}>150 </span>
              <span className={styles.valueSuffix}>USDT</span>
            </div>
          </div>

          {/* Commission */}
          <div className={styles.listItem}>
            <span className={styles.itemLabel}>Comission</span>
            <div className={styles.itemValue}>
              <span className={styles.valueLargeGreen}>15 </span>
              <span className={styles.valueSuffix}>USDT</span>
            </div>
          </div>
        </div>
        ...
        <p className={styles.disclaimer}>
          *The commission is charged from the remaining balance. We charge a
        ...
        <div className={styles.doneSection}>
          ...
          >
            ...
            >
              <path
                d="M8.667 16.25L15.167 22.75L28.167 9.75"
                stroke="#191919"
                strokeWidth="3.467"
                strokeLinecap="square"
                strokeLinejoin="round"
