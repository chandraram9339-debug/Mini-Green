...
export default function AppBar({ title, onBack, onClose }: AppBarProps) {
  return (
    <div className="w-full bg-[#ECF1F4] relative">
      {/* Status bar area */}
      <div className="h-11 w-full bg-[#ECF1F4] flex items-center px-5">
        {/* Time */}
        <span className="text-[#192B48] text-[15px] font-semibold font-outfit">9:41</span>
        ...
        <div className="ml-auto flex items-center gap-1">
          ...
          <svg width="25" height="14" viewBox="0 0 25 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M24 5C24.5523 5 25 5.44772 25 6V8C25 8.55228 24.5523 9 24 9V5Z" fill="#192B48" fillOpacity="0.6"/>
      ...
      <div className="relative flex items-center justify-center px-4 h-14">
        ...
        <button
          onClick={onBack}
          className="absolute left-4 w-8 h-8 flex items-center justify-center rounded-[30px] -rotate-90"
        >
        ...
        {/* Title */}
        <span className="text-[#192B48] text-[20px] font-medium tracking-[0.4px] font-outfit">
          {title}
        </span>
        ...
        <button
          onClick={onClose}
          className="absolute right-4 w-8 h-8 flex items-center justify-center rounded-[30px]"
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Divider */}
      <div className="mx-5 h-px bg-[#D3DAE5]" />
    </div>
  );
}
