interface TabBarProps {
  activeTab?: 'home' | 'wallet' | 'chart' | 'support';
}

export function TabBar({ activeTab = 'wallet' }: TabBarProps) {
  return (
    <div className="w-full bg-white shadow-[0_-4px_20px_0_rgba(45,110,147,0.08)] rounded-t-xl flex-shrink-0">
      <div className="flex items-center justify-center gap-[30px] px-[46px] py-[10px] h-[72px]">
        {/* Home */}
        <button className="flex items-center justify-center p-[14px] rounded-[30px]">
        ...
        {/* Wallet (active) */}
        <button className="flex items-center justify-center p-[14px] rounded-[30px] bg-[#2D6E93]">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
