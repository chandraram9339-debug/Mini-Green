type TabName = "home" | "wallet" | "chart" | "support";
...
export default function TabBar({ activeTab = "wallet" }: TabBarProps) {
  return (
    <div className="flex items-center justify-around w-full h-[72px] bg-app-white rounded-t-xl flex-shrink-0"
      style={{ boxShadow: "0 -4px 20px 0 rgba(45, 110, 147, 0.08)" }}>
      
      {/* Home */}
      <button
        className={`flex items-center justify-center w-[52px] h-[52px] rounded-[30px] ${activeTab === "home" ? "bg-app-blue-dark" : ""}`}
      >
      ...
      {/* Wallet */}
      <button
        className={`flex items-center justify-center w-[52px] h-[52px] rounded-[30px] ${activeTab === "wallet" ? "bg-app-blue-dark" : ""}`}
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Chart */}
      <button
        className={`flex items-center justify-center w-[52px] h-[52px] rounded-[30px] ${activeTab === "chart" ? "bg-app-blue-dark" : ""}`}
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4 4V20H20" stroke={activeTab === "chart" ? "white" : "#55647B"} strokeWidth="1.6" strokeLinecap="square" strokeLinejoin="round"/>
          <path d="M9 13L13 9L16 12L20 8" stroke={activeTab === "chart" ? "white" : "#55647B"} strokeWidth="1.6" strokeLinecap="square" strokeLinejoin="round"/>
        </svg>
      </button>

      {/* Support */}
      <button
        className={`flex items-center justify-center w-[52px] h-[52px] rounded-[30px] ${activeTab === "support" ? "bg-app-blue-dark" : ""}`}
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
