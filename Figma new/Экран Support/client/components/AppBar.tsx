  ...
  return (
    <div className="w-full bg-app-bg">
      <div className="flex items-center justify-between px-4 h-14">
        ...
        <button
          onClick={handleBack}
          className={`flex items-center justify-center w-8 h-8 rounded-[30px] transition-opacity ${showBack ? "opacity-100" : "opacity-0 pointer-events-none"}`}
          aria-label="Go back"
        >
        ...
        {/* Title */}
        <span className="font-outfit font-medium text-[20px] text-app-black leading-none">
          {title}
        </span>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            {/* Badge */}
            <div className="absolute -top-0.5 -right-1.5 w-[13px] h-[13px] rounded-full bg-app-blue flex items-center justify-center">
              <span className="text-white font-outfit font-medium leading-none" style={{ fontSize: "7px", letterSpacing: "0.14px" }}>
                25
              </span>
            </div>
          </div>
      ...
      {/* Divider line */}
      <div className="mx-5 h-px bg-app-grey" />
    </div>
  );
}
