...
export default function AppBar({ title, onBack, notificationCount = 3 }: AppBarProps) {
  return (
    <div className="w-full bg-app-bg">
      <div className="flex items-center justify-between px-4 h-14">
        ...
        {/* Title */}
        <span className="font-outfit font-medium text-[20px] text-app-black leading-normal">
          {title}
        </span>
        ...
        <div className="flex items-center gap-[14px]">
          ...
          <div className="relative w-6 h-6">
            ...
            {notificationCount > 0 && (
              <div className="absolute -top-0.5 -right-1.5 w-[13px] h-[13px] bg-app-blue rounded-full flex items-center justify-center">
                <span className="font-outfit font-medium text-white text-[7px] leading-none tracking-[0.14px]">
                  {notificationCount}
                </span>
              </div>
            )}
      ...
      {/* Divider */}
      <div className="mx-5 h-px bg-app-line" />
    </div>
  );
}
