export default function AppBar() {
  return (
    <header className="w-full tg-bg font-outfit">
      {/* Top bar with icons */}
      <div className="flex items-center justify-between px-4 h-14">
        {/* Back/Up button */}
        <button className="flex items-center justify-center w-8 h-8 rounded-full hover:bg-black/5 transition-colors">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="relative flex items-center justify-center w-6 h-6">
            ...
            {/* Badge */}
            <span className="absolute -top-1 -right-1 flex items-center justify-center w-[13px] h-[13px] rounded-full bg-brand-blue-dark">
              <span className="font-outfit text-white text-[7px] font-medium leading-none">
                25
              </span>
            </span>
          </button>
      ...
      {/* Divider */}
      <div className="mx-4 h-px bg-brand-grey-line" />
    </header>
  );
}
