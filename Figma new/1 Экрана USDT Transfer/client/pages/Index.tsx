export default function Index() {
  return (
    <div className="min-h-screen bg-app-bg flex items-center justify-center font-outfit">
      {/* Phone frame wrapper — full screen on mobile, centered card on desktop */}
      <div className="relative w-full max-w-[390px] min-h-screen sm:min-h-0 sm:h-[824px] bg-app-bg flex flex-col overflow-hidden sm:rounded-[40px] sm:shadow-2xl">
        ...
        {/* Main content */}
        <main className="flex-1 flex flex-col px-5 pt-6 pb-4 gap-4 overflow-hidden">

          {/* Receipt Card */}
          <ReceiptCard />

          {/* Disclaimer */}
          <p className="text-right text-[12px] leading-[18px] text-app-grey-medium ml-auto" style={{ maxWidth: "268px" }}>
        ...
        <div className="px-5 pb-4">
          <button className="w-full h-[52px] rounded-[54px] bg-app-blue text-white text-[16px] font-normal hover:opacity-90 active:opacity-80 transition-opacity">
            Confirm and Send
          </button>
        </div>
...
function StatusBar() {
  return (
    <div className="w-full h-11 bg-app-bg flex items-center justify-between px-5 flex-shrink-0">
      {/* Time */}
      <span className="text-[15px] font-semibold text-app-black">9:41</span>

      {/* Status icons */}
      <div className="flex items-center gap-1">
        {/* Network Signal */}
        <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" clipRule="evenodd" d="M3 7.5H4C4.55228 7.5 5 7.94772 5 8.5V11C5 11.5523 4.55228 12 4 12H3C2.44772 12 2 11.5523 2 11V8.5C2 7.94772 2.44772 7.5 3 7.5Z" fill="#192B48"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M7.5 6H8.5C9.05228 6 9.5 6.44772 9.5 7V11C9.5 11.5523 9.05228 12 8.5 12H7.5C6.94772 12 6.5 11.5523 6.5 11V7C6.5 6.44772 6.94772 6 7.5 6Z" fill="#192B48"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M12 4H13C13.5523 4 14 4.44772 14 5V11C14 11.5523 13.5523 12 13 12H12C11.4477 12 11 11.5523 11 11V5C11 4.44772 11.4477 4 12 4Z" fill="#192B48"/>
        ...
        <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M8.13295 8.93945C8.77245 8.93945 9.39384 9.1075 9.94135 9.42792L10.1632 9.55775C10.3314 9.65617 10.3609 9.88652 10.2231 10.024L8.32897 11.9129C8.21263 12.0289 8.02401 12.0289 7.90767 11.9129L6.02576 10.0362C5.88847 9.89927 5.91709 9.67009 6.08385 9.57094L6.3032 9.44051C6.85574 9.11198 7.48501 8.93945 8.13295 8.93945Z" fill="#192B48"/>
  ...
  return (
    <div className="w-full flex-shrink-0">
      <div className="flex items-center justify-between px-4 h-14">
        ...
        {/* Title */}
        <h1 className="text-[20px] font-medium tracking-[0.4px] text-app-black">USDT Transfer</h1>
      ...
      {/* Divider */}
      <div className="h-px bg-app-grey-line mx-5" />
    </div>
  );
}
...
function ReceiptCard() {
  return (
    <div className="bg-white rounded-xl overflow-hidden flex flex-col">
      {/* Recipient row */}
      <div className="flex items-center justify-between px-5 h-[49px]">
        <span className="text-[15px] text-app-grey-dark">Recipient</span>
        <span className="text-[18px] font-medium text-app-black">UQC4...754C</span>
      </div>
      <div className="h-px bg-app-grey-line mx-5" />

      {/* Amount row */}
      <div className="flex items-center justify-between px-5 h-[49px]">
        <span className="text-[15px] text-app-grey-dark">Amount</span>
        <div className="flex items-baseline gap-1">
          <span className="text-[18px] font-medium text-app-black">150</span>
          <span className="text-[13px] font-medium text-app-grey-medium">USDT</span>
        </div>
      </div>
      <div className="h-px bg-app-grey-line mx-5" />
      ...
      {/* Commission row */}
      <div className="flex items-center justify-between px-5 h-[49px]">
        <span className="text-[15px] text-app-grey-dark">Comission</span>
        <div className="flex items-baseline gap-1">
          <span className="text-[18px] font-medium text-app-black">15</span>
          <span className="text-[13px] font-medium text-app-grey-medium">USDT</span>
        </div>
      </div>
    </div>
...
function TabBar() {
  return (
    <div className="flex-shrink-0 bg-white rounded-t-xl shadow-[0_-4px_20px_0_rgba(45,110,147,0.08)] flex items-center justify-around px-[46px] h-[72px]">
      {/* Home */}
      <button className="flex items-center justify-center w-[52px] h-[52px] rounded-full hover:bg-black/5 transition-colors">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Wallet (active) */}
      <button className="flex items-center justify-center w-[52px] h-[52px] rounded-full bg-app-blue transition-colors">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
