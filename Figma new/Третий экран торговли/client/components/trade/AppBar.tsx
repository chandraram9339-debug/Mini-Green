...
export default function AppBar({ onBack, notificationCount = 25 }: AppBarProps) {
  return (
    <div className="sticky top-0 z-40 w-full bg-bot-bg">
      {/* App Header */}
      <div className="relative flex items-center justify-between px-4 h-14">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            {notificationCount > 0 && (
              <div className="absolute -top-1 -right-1 flex items-center justify-center w-[13px] h-[13px] rounded-full bg-bot-blue">
                <span className="text-white font-outfit font-medium" style={{ fontSize: "7px" }}>
                  {notificationCount}
                </span>
              </div>
            )}
      ...
      {/* Divider */}
      <div className="mx-4 h-px bg-bot-grey-line" />
    </div>
  );
}
